...
processa_eve_high1:-findall(ev_high(AgM,E,T),clause(ev_high(AgM,E,T),_),L),
          ...
          if(once(eve_cond(E)),processa_eve_high(Ag,E,T),no_proc_eve_high(Ag,E,T)),
              M==U,!.
no_proc_eve_high(AgM,E,T):-write(''),retractall(ev_high(_,E,T)),asse_cosa(refused_external(AgM,E,T)).
...
no_proc_eve_normal(AgM,E,T):-write(''),retractall(ev_normal(_,E,T)),
                          asse_cosa(refused_external(AgM,E,T)).
/* */

no_proc_eve_normal_no_time(AgM,E,T):-write(''), retractall(ev_normal(_,E,T)), % se gli eventi esterni sono maggiori di 1 e il deltaTime non � presente 
                          asse_cosa(refused_external(AgM,E,T)).
